...
async function downloadInstagram(url) {
  ...
  return {
    ...
    // IG gak punya audio terpisah. Kalau user minta MP3,
    // kita pakai videoUrl terus extract audio-nya pake ffmpeg.
    audioUrl: isVideo ? mediaUrl : null,
    audioFromVideo: isVideo, // flag: audio perlu extract dari video
  };
}
