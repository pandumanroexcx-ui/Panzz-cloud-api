...
// Khusus: ambil VIDEO dari URL, extract AUDIO jadi MP3, upload ke WhatsApp
async function relayVideoUrlToAudioMediaId(url, extraHeaders = {}) {
  ...
  // Detect ext dari content-type atau URL
  let ext = 'mp4';
...
module.exports = {
  uploadImage, downloadMedia, uploadSticker, uploadMedia,
  relayUrlToMediaId, relayVideoUrlToAudioMediaId,
};
